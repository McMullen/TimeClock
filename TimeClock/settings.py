...
SECRET_KEY = 'lgoz(!(fz-c5eaz)9!lyzf-2=by0#z=q6v%^@7*qg+zf!$pkgm'
...
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "TimeClock",
                            "static", "static-only")

# If user wants to upload a picture
MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), "TimeClock",
                            "static", "media")

# CSS and javascript files go here
STATICFILES_DIRS = (
    os.path.join(os.path.dirname(BASE_DIR), "TimeClock",
                     "static", "static"),
    )
